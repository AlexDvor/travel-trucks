...
**Travel Trucks** is a single-page web application for browsing and
exploring camper vans. Users can filter vehicles, view detailed
information, read reviews, and add campers to their favorites list.

The project is built as an SPA using React, with routing, global state
management, and integration with a remote API.
